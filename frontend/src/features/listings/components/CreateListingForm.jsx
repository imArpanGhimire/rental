            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <SelectField {...register("furnished")}>
                    <option value="false" className={OPTION_CLASS}>
                      Unfurnished
                    </option>

                    <option value="true" className={OPTION_CLASS}>
                      Furnished
                    </option>
                  </SelectField>
                </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div>
                  ...
                  <SelectField {...register("genderPreference")}>
                    <option value="any" className={OPTION_CLASS}>
                      Any
                    </option>

                    <option value="male" className={OPTION_CLASS}>
                      Male
                    </option>

                    <option value="female" className={OPTION_CLASS}>
                      Female
                    </option>
                  </SelectField>
                </div>
                ...
                <div>
                  ...
                  <SelectField {...register("waterSupply")}>
                    <option value="" className={OPTION_CLASS}>
                      Not specified
                    </option>

                    <option value="municipal" className={OPTION_CLASS}>
                      Municipal
                    </option>

                    <option value="tanker" className={OPTION_CLASS}>
                      Tanker
                    </option>

                    <option value="jar" className={OPTION_CLASS}>
                      Jar
                    </option>

                    <option value="borewell" className={OPTION_CLASS}>
                      Borewell
                    </option>
                  </SelectField>
                </div>
          ...
          {isEdit && (
            ...
            >
              <div>
                ...
                <SelectField {...register("isAvailable")}>
                  <option value="true" className={OPTION_CLASS}>
                    Available
                  </option>
