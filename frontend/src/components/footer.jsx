...
export default function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center gap-8 px-4 sm:px-8 py-3.5 bg-white/85 backdrop-blur-md shadow-[0_1px_0_rgba(20,20,26,0.06),0_12px_24px_-16px_rgba(20,20,26,0.12)]">
      <NavLink
        to="/"
