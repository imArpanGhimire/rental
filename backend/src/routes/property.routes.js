...
router.post("/upload-image", authMiddleware, ownershipMiddleware, upload.single("image"), propertycontroller.uploadimage)
...
router.post("/polygon-search", propertycontroller.getpropertiesinpolygon)
